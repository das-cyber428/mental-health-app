...
function Scene({ mood, onOrbClick }) {
  return (
    <>
      ...
      <Float speed={1.2} rotationIntensity={0.25} floatIntensity={0.7}>
        <AIOrb mood={mood} onClick={onOrbClick} position={[0.15, 0.2, 0]} />
      </Float>
...
export default function HeroCanvas({ mood, onOrbClick }) {
  return (
    <div className="absolute inset-0">
      ...
      >
        <Suspense fallback={null}>
          <Scene mood={mood} onOrbClick={onOrbClick} />
        </Suspense>
      </Canvas>
    </div>
  );
